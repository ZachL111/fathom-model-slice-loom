"""Regression checks for the fathom-model-slice-loom casebook."""
...
from casebook.harness import assert_expected, fathom_model_slice_loom_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(fathom_model_slice_loom_summary(), assert_expected())
